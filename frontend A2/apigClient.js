...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://xrip8jh607.execute-api.us-east-1.amazonaws.com/test';
    ...
    apigClient.uploadBucketKeyPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['x-amz-meta-customLabels', 'key', 'bucket', 'Content-Type'], ['body']);
